...
export default function TypingTest({ onComplete, initialDuration: _initialDuration, initialMode = 'passage', initialCustomText = '', compact = false }: Props) {
