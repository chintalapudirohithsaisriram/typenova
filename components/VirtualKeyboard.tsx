...
export default function VirtualKeyboard({ targetKey = '', showFingerGuide = true, onKeySelect }: Props) {
  ...
  return <div className="keyboard-wrap" aria-label="Visual keyboard and finger guide">
    ...
    <div className="keyboard">
      ...
      <div className="shift-row"><button type="button" className="key shift-key" onMouseDown={(event) => event.preventDefault()} aria-label="Left Shift key"><span>shift</span><small>left pinky</small></button><button type="button" className={`key space-key ${target === ' ' ? 'key-active guide-target' : ''}`} onMouseDown={(event) => event.preventDefault()} onClick={() => selectKey(' ')} aria-label="Space key"><span>space</span>{showFingerGuide && target === ' ' && <small>thumbs</small>}</button><button type="button" className="key shift-key" onMouseDown={(event) => event.preventDefault()} aria-label="Right Shift key"><span>shift</span><small>right pinky</small></button></div>
    </div>
    ...
    <style jsx>{`
      .finger-coach{position:relative;display:grid;grid-template-columns:150px minmax(180px,1fr) minmax(190px,.9fr);align-items:center;gap:16px;margin-bottom:16px;padding:16px 18px;border:1px solid var(--line);border-radius:18px;background:var(--surface);overflow:hidden;box-shadow:0 10px 28px color-mix(in srgb,var(--ink) 8%,transparent);pointer-events:none;user-select:none}
      .coach-visual{height:74px;position:relative;display:grid;place-items:center}.coach-hand{position:relative;width:76px;height:48px;padding:0 8px 8px;display:flex;align-items:flex-end;justify-content:center;gap:3px;border-radius:14px 14px 20px 20px;background:color-mix(in srgb,var(--accent) 38%,var(--surface));border:1px solid var(--accent-strong);transform:rotate(-5deg)}.right-hand{transform:scaleX(-1) rotate(-5deg)}.both-hands{width:90px}.finger-shape{width:10px;border:1px solid var(--accent-strong);background:color-mix(in srgb,var(--accent) 72%,var(--surface));border-radius:9px 9px 4px 4px;transform-origin:bottom;transition:transform .16s ease,background .16s ease,box-shadow .16s ease}.finger-shape.pinky{height:25px}.finger-shape.ring{height:35px}.finger-shape.middle{height:40px}.finger-shape.index{height:37px}.finger-shape.finger-active{background:var(--accent-strong);box-shadow:0 0 0 3px color-mix(in srgb,var(--accent) 22%,transparent);transform:translateY(-5px)}.thumb-shape{position:absolute;width:24px;height:12px;bottom:4px;left:7px;border:1px solid var(--accent-strong);background:color-mix(in srgb,var(--accent) 72%,var(--surface));border-radius:10px;transform:rotate(32deg);transition:transform .16s ease,background .16s ease,box-shadow .16s ease}.thumb-shape.finger-active{background:var(--accent-strong);box-shadow:0 0 0 3px color-mix(in srgb,var(--accent) 22%,transparent);transform:rotate(32deg) translateY(-3px)}.move-line{position:absolute;width:48px;height:12px;right:4px;top:18px;border-top:1px solid color-mix(in srgb,var(--accent-strong) 55%,transparent);border-radius:50%;opacity:.65}
      .finger-coach-copy{display:grid;gap:2px;position:relative;z-index:1}.coach-kicker{font-size:10px;text-transform:uppercase;letter-spacing:.12em;color:var(--muted);font-weight:800}.finger-coach-copy strong{font-family:var(--mono);font-size:25px;line-height:1.1}.finger-coach-copy span{font-size:13px}.finger-coach-copy small{color:var(--muted);font-size:11px;line-height:1.4}.finger-lanes{display:grid;grid-template-columns:1fr 1fr;gap:6px}.finger-lane{display:flex;align-items:center;gap:7px;padding:7px 8px;border:1px solid var(--line);border-radius:9px;color:var(--muted);font-size:10px;text-transform:uppercase;letter-spacing:.04em}.finger-lane i{width:8px;height:8px;border-radius:50%;background:var(--line)}.finger-lane.active{color:var(--ink);font-weight:900;border-color:var(--accent-strong);background:color-mix(in srgb,var(--accent) 13%,var(--surface))}.finger-lane.active i{background:var(--accent-strong);transform:scale(1.5)}
      .guide-target{animation:keyGuidePulse 1s ease-in-out infinite}.shift-row{display:grid;grid-template-columns:1.5fr 3fr 1.5fr;gap:6px}.shift-key{min-height:45px}.space-key{width:100%;margin:0}
      @keyframes keyGuidePulse{0%,100%{box-shadow:0 0 0 2px color-mix(in srgb,var(--accent) 22%,transparent)}}
